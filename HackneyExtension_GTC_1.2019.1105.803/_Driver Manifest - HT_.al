report 50004 "Driver Manifest - HT"
{
        ...
        "Logistics Run Header")
        {
            ...
            "Misc. Logistics Run Line")
            {
                ...
                begin
                    ...
                    if grecTEMPLogLine.FindLast() then
                        gintLineNo := grecTEMPLogLine."Line No." + 10000
                    else
                        gintLineNo := 10000;
                    //</JF5352SHR>
                end;
                ...
                "Integer")
                {
                    ...
                    "Integer")
                    {
                        ...
                        "Integer")
                        {
                            ...
                            begin
                                gintOnCommNumber += 1;
                                with grecTEMPCommentLine do if gintOnCommNumber = 1 then
                                        Find('-')
                                    else
                                        Next();
                            end;
                            ...
                            begin
                                gintCommCounter := 0;
                                gintOnCommNumber := 0;
                                if not gblnPrintSourceDocComm then
                                    CurrReport.Break()
                                else begin
                        ...
                        "Integer")
                        {
                            ...
                            begin
                                gintCommCounter := 0;
                                gintOnCommNumber := 0;
                                if not gblnPrintSourceRefDocComm then
                                    CurrReport.Break()
                                else begin
                        ...
                        begin
                            ...
                            with grecTEMPLogLine do begin
                                ...
                                case Type of
                                    Type::Pickup:
                                        if grecTEMPLogLine."Seal No." = '' then
                                            gcodSealDisplay := '________________________________'
                                        else
                                ...
                                Clear(SourceAddress);
                                //<JF5352SHR>
                                if grecTEMPMiscLogRunLine.Get(grecTEMPLogLine."Run No.", grecTEMPLogLine."Line No.") then
                                    FormatAddress.jfMiscLogRunAddress(SourceAddress, grecTEMPMiscLogRunLine)
                                else
                                    //</JF5352SHR>
                                    case grecTEMPLogLine."Pick-up/Drop-off Type" of
                                        grecTEMPLogLine."Pick-up/Drop-off Type"::Customer:
                                            if grecTEMPLogLine."Pick-up/Drop-off Code" <> '' then begin
                                                ...
                                                if lrecCustomer.Get(grecTEMPLogLine."Pick-up/Drop-off No.") then FormatAddress.Customer(SourceAddress, lrecCustomer);
                                        grecTEMPLogLine."Pick-up/Drop-off Type"::Vendor:
                                            if grecTEMPLogLine."Pick-up/Drop-off Code" <> '' then begin
                                                ...
                                                if lrecVendor.Get(grecTEMPLogLine."Pick-up/Drop-off No.") then FormatAddress.Vendor(SourceAddress, lrecVendor);
                                        grecTEMPLogLine."Pick-up/Drop-off Type"::Location:
                                            if lrecLocation.Get(grecTEMPLogLine."Pick-up/Drop-off No.") then
                                                FormatAddress.jfLocation(SourceAddress, lrecLocation);
                                    end;
                                //<JF5352SHR>
                                //</JF5352SHR>
                            end;
            ...
            trigger OnAfterGetRecord()
            var
                lrecShipAgent: Record "Shipping Agent";
            begin
    ...
    requestpage
    {
        ...
        var
            myInt: Integer;
        begin
            gblnPrintSourceDocComm := True; //EN1.00
            gblnPrintSourceRefDocComm := True;  //EN1.00    
        end;
    }
    labels
    {
    ...
    procedure jfGetSourceDocComments()
    var
        lrecWhseShip: Record "Warehouse Shipment Header";
    ...
    begin
        ...
        Clear(grecTEMPCommentLine);
        with grecTEMPLogLine do begin
            case grecTEMPLogLine."Source Document" of
                "Source Document"::"Warehouse Shipment":
                    begin
                ...
                "Source Document"::"Warehouse Receipt":
                    begin
    ...
    procedure jfGetSourceRefDocComments()
    var
    ...
    begin
        ...
        Clear(grecTEMPCommentLine);
        with grecTEMPLogLine do begin
            case "Source Doc. Ref. Type" of
                "Source Doc. Ref. Type"::"Sales Order":
                    begin
                ...
                "Source Doc. Ref. Type"::"Transfer Order":
                    begin
                ...
                "Source Doc. Ref. Type"::"Purchase Order":
                    begin
