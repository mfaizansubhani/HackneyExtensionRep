report 50003 "Vendor Commissions Report - HT"
{
  ...
  begin
    ...
    if("Type" = Type::Item) and ("No." <> '')then begin
      ...
      if grec_ItemCrossReference."Bar Code Type Code" = 'GTIN' then gtxt_GTIN_SIL:=grec_ItemCrossReference."Cross-Reference No."
      else
      begin
  ...
  begin
    ...
    if("Type" = Type::Item) and ("No." <> '')then begin
      ...
      if grec_ItemCrossReference."Bar Code Type Code" = 'GTIN' then gtxt_GTIN_SCML:=grec_ItemCrossReference."Cross-Reference No."
      else
      begin
        grec_ItemCrossReference.SetRange("Cross-Reference Type");
        grec_ItemCrossReference.SetRange("Bar Code Type Code", 'GTIN');
  ...
  begin
    ...
    case "Document Type" of "Document Type"::Invoice: begin
    ...
    "Document Type"::Adjustment: begin
  ...
  trigger OnPreDataItem();
  var ljftext000: Label 'Please Specify a Date filter for the report';
  ...
  var grecCompanyInfo: Record "Company Information";
  ...
  begin
    ...
    if grceTempCommJnlLine.FINDSET()then repeat if grceTempCommJnlLine."Amount (LCY)" <> 0 then begin
